define([
    ...
    ARecord.Models.Record = Backbone.Model.extend();

    ARecord.Collections.Records = Backbone.Collection.extend({
        model: ARecord.Models.Record,
        initialize: function( options ) {
            this.zone_id = options.zone_id;
            this.url = '/api/zone/' + options.zone_id + '/cname';
        }
    });

    ARecord.Views.Layout = Backbone.View.extend({
        initialize: function( options ) {
            this.zone_id = options.zone_id;
            this.zone = options.zone;

            this.records = new ARecord.Collections.Records({
        ...
        addOne: function( model ) {
            var view = new ARecord.Views.Item({ model: model });
    ...
    ARecord.Views.Item = Backbone.View.extend({
        tagName: 'tr',
