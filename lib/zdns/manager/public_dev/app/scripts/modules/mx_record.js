define([
    ...
    MxRecord.Models.Record = Backbone.Model.extend();

    MxRecord.Collections.Records = Backbone.Collection.extend({
        model: MxRecord.Models.Record,
        initialize: function( options ) {
            this.zone_id = options.zone_id;
            this.url = '/api/zone/' + options.zone_id + '/mx';
        }
    });

    MxRecord.Views.Layout = Backbone.View.extend({
        initialize: function( options ) {
            this.zone_id = options.zone_id;
            this.zone = options.zone;

            this.records = new MxRecord.Collections.Records({
        ...
        addOne: function( model ) {
            var view = new MxRecord.Views.Item({ model: model });
    ...
    MxRecord.Views.Item = Backbone.View.extend({
        tagName: 'tr',
