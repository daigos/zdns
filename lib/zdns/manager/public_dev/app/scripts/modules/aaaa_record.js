define([
    ...
    var AaaaRecord = zdns.module({ Models: {}, Collections: {} });

    AaaaRecord.Models.Record = Backbone.Model.extend();

    AaaaRecord.Collections.Records = Backbone.Collection.extend({
        model: AaaaRecord.Models.Record,
        initialize: function( options ) {
            this.zone_id = options.zone_id;
            this.url = '/api/zone/' + options.zone_id + '/aaaa';
        }
    });

    AaaaRecord.Views.Layout = Backbone.View.extend({
        initialize: function( options ) {
            this.zone_id = options.zone_id;
            this.zone = options.zone;

            this.records = new AaaaRecord.Collections.Records({
        ...
        addOne: function( model ) {
            var view = new AaaaRecord.Views.Item({ model: model });
    ...
    AaaaRecord.Views.Item = Backbone.View.extend({
        tagName: 'tr',
