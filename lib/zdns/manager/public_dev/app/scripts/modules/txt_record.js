define([
    ...
    TxtRecord.Models.Record = Backbone.Model.extend();

    TxtRecord.Collections.Records = Backbone.Collection.extend({
        model: TxtRecord.Models.Record,
        initialize: function( options ) {
            this.zone_id = options.zone_id;
            this.url = '/api/zone/' + options.zone_id + '/txt';
        }
    });

    TxtRecord.Views.Layout = Backbone.View.extend({
        initialize: function( options ) {
            this.zone_id = options.zone_id;
            this.zone = options.zone;

            this.records = new TxtRecord.Collections.Records({
        ...
        addOne: function( model ) {
            var view = new TxtRecord.Views.Item({ model: model });
    ...
    TxtRecord.Views.Item = Backbone.View.extend({
        tagName: 'tr',
